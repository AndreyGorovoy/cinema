...
<body>
<!-- Add a legend at the top of the page (below nav bar) as a title --> 
		<legend><center><b>Add User</b></center></legend>	
		<center>
...
<!--Also add a submit button that when pressed enters the information into the database -->
		<form id='register' action='asignup.php' method='post'>
		...
		<label for='name' > Date of Birth (YYYYMMDD): </label>
...
<!-- Type = password stops the password form being shown in plain text -->		
		<button class="btn btn-large btn-primary" type="submit" value="submit" style="width:300px">Add User</button></p>
		</form>
		</center>
		</br>
	</font>
...
//if unsuccessful display Message
